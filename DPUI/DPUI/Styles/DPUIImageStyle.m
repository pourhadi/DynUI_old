...
@implementation DPUIImageStyle

- (void)applyToImage:(UIImage *)image
{
	DPUIBackgroundStyle *background = self.overlay;
    if (background) {
        
        DPUIShadowStyle *innerShadow = self.innerShadow;
        ...
        if (self.outerShadow) {
            ...
            DPUIShadowStyle *outerShadow = self.outerShadow;
